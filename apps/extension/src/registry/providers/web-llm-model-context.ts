...
export const WEB_LLM_MODEL_CONTEXT: Record<string, WebLLMModelContext> = {
  ...
  "Qwen3-1.7B-q4f16_1-MLC": { contextWindow: 16384, overrideContextWindowSize: 16384, prefillChunkSize: 2048, slidingWindow: false, vramRequiredMB: 2036.66, lowResource: true },
  "Qwen3-1.7B-q4f32_1-MLC": { contextWindow: 16384, overrideContextWindowSize: 16384, prefillChunkSize: 2048, slidingWindow: false, vramRequiredMB: 2635.44, lowResource: true },
  "Qwen3-4B-q4f16_1-MLC": { contextWindow: 16384, overrideContextWindowSize: 16384, prefillChunkSize: 2048, slidingWindow: false, vramRequiredMB: 3431.59, lowResource: true },
  "Qwen3-4B-q4f32_1-MLC": { contextWindow: 16384, overrideContextWindowSize: 16384, prefillChunkSize: 2048, slidingWindow: false, vramRequiredMB: 4327.71, lowResource: true },
